...
def main():
    ...
    input_documents = []
    for row in rows_of_ids:
        content_of_row = row['content']
        input_documents.append(content_of_row)


    # 接入LLM
    result = accessLLM.MiniMax(question=question, input_documents=input_documents) 
    print(result)
